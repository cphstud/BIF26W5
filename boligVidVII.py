...
resdf2=resdf.drop(columns=['kommunekode','nr','kommuner','href','stormodtageradresser', 'bbox', 'visueltcenter','ændret', 'geo_ændret', 'geo_version', 'dagi_id'])
resdf2=resdf2.drop_duplicates()
dfboligzip=pd.merge(dfboligsub2,resdf2,how="left",on="postnr")
